// this is an alternate solution to this challenge
// it uses fewer functions, e.g. fetches are executed in global scope and 
// some functions are less modular with less separation of concerns
